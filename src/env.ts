...
export const env = createEnv({
  server: {
    ...
    GOOGLE_SHARED_ADMIN_USER_ID: requiredValue.optional(),
    GOOGLE_SHARED_ALLOWED_USER_IDS: requiredValue.optional(),
    LINEAR_CONNECTOR_UID: requiredValue.default("linear/open"),
